...
class Program
{
    ...
    static readonly Dictionary<string, int> ItemNameToIdMap =
        new()
        {
            ...
            { "Zamorak brew(3)", 189 },
            { "Attack potion(4)", 2436 },
            { "Antipoison(4)", 2448 },
            { "Strength potion(4)", 2440 },
            { "Serum 207(4)", 3414 },
            { "Compost potion(4)", 6478 },
            { "Restore potion(4)", 2432 },
            { "Energy potion(4)", 3014 },
            { "Combat potion(4)", 9742 },
            { "Defence potion(4)", 2444 },
            { "Prayer potion(4)", 2430 },
            { "Agility potion(4)", 3038 },
            { "Saradomin brew(4)", 6697 },
            { "Super attack(4)", 2436 },
            { "Superantipoison(4)", 2448 },
            { "Fishing potion(4)", 151 },
            { "Super energy(4)", 3022 },
            { "Hunter potion(4)", 10002 },
            { "Super strength(4)", 2444 },
            { "Super restore(4)", 3028 },
            { "Super defence(4)", 2448 },
            { "Antifire potion(4)", 2458 },
            { "Magic potion(4)", 3046 },
            { "Ranging potion(4)", 170 },
            { "Zamorak brew(4)", 189 },
        };
